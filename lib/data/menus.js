...
const navLinks = [
  ...
  { 
    ...
    submenu: [
      ...
      { name: "Fire ( SITC )", href: "/fire-sitc", title: "Fire & Safety Systems and Compliance Solutions", alt: "Fire ( SITC )", pdf: "/pdf/electrical-sitc.pdf" },
      { name: "PNG ( SITC )", href: "/png-sitc", title: "Piped Natural Gas (Png) Services & Regulatory Compliance", alt: "PNG ( SITC )", pdf: "/pdf/electrical-sitc.pdf" },
      { name: "Equipment Solution Department ( ESD )", href: "/equipment-solution-department-esd", title: "Equipment Solution Department", alt: "( ESD )", pdf: "/pdf/electrical-sitc.pdf" },
